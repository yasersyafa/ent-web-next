...
export default function Navbar() {
    ...
    return (
        <nav className="px-6 sticky top-6">
        <div className="mx-auto max-w-7xl">
          ...
          {/* Mobile Menu */}
          {isMobileMenuOpen && (
            <div className="md:hidden mt-4 rounded-2xl bg-white shadow-lg border border-gray-200 overflow-hidden">
              <div className="flex flex-col">
                <a href="#" className="px-6 py-4 text-gray-700 hover:bg-gray-50 border-b border-gray-100">
                  About
                </a>
                <a href="#" className="px-6 py-4 text-gray-700 hover:bg-gray-50 border-b border-gray-100">
                  Division
